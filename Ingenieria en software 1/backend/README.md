...
# Execute only the n8n tests (email and password reset) - requires N8N to be running
mvn test -P n8n-tests

# Execute only the n8n test for email send
mvn test -P n8n-tests -Dtest=N8NEmailTest

# Execute only the n8n test for password reset
mvn test -P n8n-tests -Dtest=N8NPasswordResetTest

...
public class ComboConstants {
    public static final String COMBOS_ENDPOINT = "/combos";

    public static final int MIN_COMBO_QUANTITY = 0;
    ...
    public static final String ERROR_DUPLICATE_NAME = "No se puede crear el combo: está presente uno con el mismo nombre";
